...
/* Some NUS-CIC-6105 SP tasks try to clear some zeroed DPC registers. */
    DPC_TMEM_REG     &= !(SR[rt] & 0x00000040) * -1;
 /* DPC_PIPEBUSY_REG &= !(SR[rt] & 0x00000080) * -1; */
 /* DPC_BUFBUSY_REG  &= !(SR[rt] & 0x00000100) * -1; */
    DPC_CLOCK_REG    &= !(SR[rt] & 0x00000200) * -1;
    return;
}
